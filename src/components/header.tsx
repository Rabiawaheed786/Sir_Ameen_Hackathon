  ...
  return (
    <>
      <div className="w-full flex flex-col">
        ...
        {/* Top Bar */}
        <div className="h-[45px] flex items-center justify-between py-[14px] px-4 sm:px-6 text-[#FFFFFF] bg-[#272343]">
          <div className="flex items-center gap-[8px]">
            <FaCheck size={16} />
            <p className="text-[13px] leading-[14.3px]">Free shipping on all orders over $50</p>
          </div>
          <div className="flex gap-[16px] sm:gap-[24px] text-[13px] leading-[16px]">
            <DropdownMenu>
        ...
        <div className="flex items-center justify-between bg-[#F0F2F3] py-[20px] px-4 sm:px-6 flex-wrap">
          <div className="flex items-center gap-[8px]">
            <Image src="/logo.png" alt="logo" width={40} height={40} />
            <h2 className="text-[20px] sm:text-[26px] leading-[31px] font-medium">Comforty</h2>
          </div>
          <div className="flex items-center gap-[8px] mt-4 sm:mt-0 py-[11px] px-[16px] bg-white rounded-[8px]">
            <LuShoppingCart size={22} />
            <p className="text-[12px] sm:text-[14px] leading-[13px] font-medium">Cart</p>
            <Button size="icon" className="h-[20px] w-[20px] rounded-full bg-[#007580]">2</Button>
          </div>
        </div>

        {/* Navigation Bar */}
        <div className="flex items-center justify-between py-[20px] px-4 sm:px-6 border-b-[1px] flex-wrap">
          <ul className="flex gap-[16px] sm:gap-[32px] flex-wrap">
          ...
          <div className="flex gap-[8px] items-center mt-4 sm:mt-0">
