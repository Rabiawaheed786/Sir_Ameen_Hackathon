...
function Hero() {
  return (
    <section className="w-full flex flex-col lg:flex-row items-center justify-between px-6 lg:px-[70px] pt-8 lg:pt-[115px] pb-8 lg:pb-[151px] bg-[#F0F2F3]">
      ...
      {/* Text Content */}
      <div className="flex flex-col gap-6 lg:gap-[24px] text-center lg:text-left max-w-full lg:max-w-[50%]">
        <p className="text-sm lg:text-[14px] leading-[14px] tracking-widest text-[#272343] uppercase">
          Welcome to Chairy
        </p>
      ...
      {/* Image Content */}
      <div className="mt-8 lg:mt-0 flex justify-center lg:justify-end max-w-full lg:max-w-[50%]">
        <Image 
          src="/main.png" 
          alt="chair" 
          width={434} 
          height={584} 
          className="w-full max-w-[434px] lg:max-w-[600px] object-cover" 
        />
      </div>
